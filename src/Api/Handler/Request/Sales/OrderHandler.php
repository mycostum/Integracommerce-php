...
use IntegraCommerce\Api\EntityInterface\Sales\Order;
use IntegraCommerce\Api\Handler\Request\HandlerAbstract;

use IntegraCommerce\Api\DataTransformer\Sales\Order\Invoice as InvoiceTransformer;
use IntegraCommerce\Api\DataTransformer\Sales\Order\Cancel as CancelTransformer;
use IntegraCommerce\Api\DataTransformer\Sales\Order\Delivery as DeliveryTransformer;
use IntegraCommerce\Api\DataTransformer\Sales\Order\Shipment as ShipmentTransformer;
use IntegraCommerce\Api\DataTransformer\Sales\Order\ShipmentException as ShipmentExceptionTransformer;
...
class OrderHandler extends HandlerAbstract
{
    ...
    /** @var string */
    protected $baseUrlPath = '/Order';


    /**
     * Retrieves a list of all orders available in IntegraCommerce.
     *
     * @param int    $page
     * @param int    $perPage
    ...
    /**
     * Invoice an order in IntegraCommerce.
     *
     * @var string $orderId
    ...
    /**
     * Cancel an order in IntegraCommerce.
     *
     * @var string $orderId
     * @var string $status
     *
