...
namespace IntegraCommerce\Api\Log;

use Monolog\Handler\StreamHandler;
use Monolog\Logger as MonologLogger;
use IntegraCommerce\Api\Log\TypeInterface\TypeRequestInterface;
use IntegraCommerce\Api\Log\TypeInterface\TypeResponseInterface;
use IntegraCommerce\Api\Exception\JsonDataConvert;
...
class Logger extends LoggerAbstract
{
    ...
    {
        echo $filePath = trim(rtrim($filePath, "\/"));
        die();
    ...
    public function logRequest(TypeRequestInterface $request)
    {
        ...
        $json = (string) $request;
        if (empty($json)) {
            throw new JsonDataConvert('IntegraCommerce PHP: Array cannot be converted to json format.');
        }
