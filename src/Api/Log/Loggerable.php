...
trait Loggerable
{
    ...
    /** @var string */
    protected $logName     = 'integracommerce_api';
    
    /** @var string */
    protected $logFileName = 'integracommerce_api.log';
    ...
    /**
     * @return \IntegraCommerce\Api\Log\Logger
     */
     ...
     * @return $this
     */
    public function setLogName($name = 'integracommerce_api')
    {
     ...
     * @return $this
     */
    public function setLogFileName($filename = 'integracommerce_api.log')
    {
